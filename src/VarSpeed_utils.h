...
int coordinate_to_id(Coordinate coordinate) {
    ...
    */
	...
	// Updated
//    if (coordinate.row == 1 && coordinate.col == -1) return 3;
//    else if (coordinate.row == 1 && coordinate.col == 0) return 2;
//    else if (coordinate.row == 1 && coordinate.col == 1) return 1;
//    else if (coordinate.row == 0 && coordinate.col == -1) return 4;
//    else if (coordinate.row == 0 && coordinate.col == 1) return 0;
//    else if (coordinate.row == -1 && coordinate.col == -1) return 5;
//    else if (coordinate.row == -1 && coordinate.col == 0) return 6;
//    else if (coordinate.row == -1 && coordinate.col == 1) return 7;
}
...
long ocps_key(State curr, State target, int path_id) {
	/*
...
void mirror_state(State source, State& target, int orientation) {
	if (orientation == 0) {
        ...
        if (source.orientation == 7) {
            target.orientation = 1;
        }
        else if (source.orientation == 6) {
            target.orientation = 2;
        }
        else if (source.orientation == 5) {
...
void get_candidate_subset(std::vector<int>* &subset, State curr, State target) {
...
void rotate_target(State& target) {
...
void get_basic_symmetric_targets(std::vector<State>* &targets, int curr_orientation) {
