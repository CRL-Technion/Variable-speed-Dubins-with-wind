...
public: 
  // constructor and destructor
	...
	void set_wind(double wx, double wy) {m_wind.x = wx; m_wind.y = wy;};
    ...
    // void computePathHistoryWithWind();
    void print();
	void printCandidate(); 
  ...
  void writeSwitchingPtPlotCommands(std::string fileName, int figureNumber, 
	...
	double get_wind_x() {return m_wind.x;};
    double get_wind_y() {return m_wind.y;};
    Wind get_wind() {return m_wind;};
    ...
    arma::mat get_pathHistory() {return m_pathHistory;};
    arma::mat get_switchingPts();
